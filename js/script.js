...
<p><strong>한 줄 정리:</strong> "이더리움이 벤츠라면 솔라나는 테슬라. 빠르고 싸고 혁신적. 근데 가끔 서버 다운됨ㅋㅋ"</p>
                ...
                readTime: 7,
                image: 'https://images.unsplash.com/photo-1617395761910-42e45ad3e0f1?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 5,
...
<p><strong>한 줄 정리:</strong> "테슬라는 자동차 회사가 아니라 AI/에너지 회사. 근데 CEO가 트위터에서 정치질하면 주가 털림ㅋㅋ"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1603356033288-acfcb54801e6?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 6,
...
<p><strong>한 줄 정리:</strong> "삼성이 드디어 일 냈다! 테슬라 22조 먹고 TSMC 추격 시작. 5만원대가 마지막 승차 기회일지도?"</p>
                ...
                readTime: 7,
                image: 'https://images.unsplash.com/photo-1592155931584-901ac15763e6?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 7,
...
<p><strong>한 줄 정리:</strong> "서울 27.7%가 15억 넘었다. MZ는 마용성 전세 살면서 리츠로 월 6% 받자. 집값? 포기하면 편해"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1570554520913-ce2192a74574?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 8,
...
<p><strong>한 줄 정리:</strong> "한미약품이 체중 -40% 신약 만들었다. 노보, 릴리 제쳤다고? 주가 44만원 가즈아!"</p>
                ...
                readTime: 9,
                image: 'https://images.unsplash.com/photo-1576773689115-0d3b76813dc5?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 9,
...
<p><strong>한 줄 정리:</strong> "적자지만 사용자는 폭증 중. 수익 모델만 찾으면 대박. 근데 그게 언제?"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1629380166023-f8151cd57618?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 11,
...
<p><strong>한 줄 정리:</strong> "3년 묶였던 XRP 곧 풀린다. 국제송금 혁명 일으키면 10달러는 기본"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1640826514546-7d2c3b8b9b0f?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 14,
...
<p><strong>한 줄 정리:</strong> "38,500원은 바닥. AI로 제2 전성기 열면 5만원 간다"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1612810806695-30f7a8258391?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 15,
...
<p><strong>한 줄 정리:</strong> "결제 독점 + 영업이익률 67% = 망할 수 없는 회사. 350달러 확정"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1560707303-4e980ce876ad?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 19,
...
<p><strong>한 줄 정리:</strong> "74달러→9달러 폭락은 끝. 대선 시즌 다가오면 최소 2배는 간다"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1617673084497-92b20e7a9c67?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 22,
...
<p><strong>한 줄 정리:</strong> "AV 레전드도 코인은 못 살림. 10만불 시총이면 이미 죽은 코인"</p>
                ...
                readTime: 6,
                image: 'https://images.unsplash.com/photo-1536431311719-398b6704d4cc?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 24,
...
<p><strong>한 줄 정리:</strong> "블랙록이 선택한 앱토스! 기관 머니 유입으로 $20 간다"</p>
                ...
                readTime: 7,
                image: 'https://images.unsplash.com/photo-1639152201720-5e536d254d81?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 28,
...
<p><strong>한 줄 정리:</strong> "PEPE 밈코인 3위 등극! 20배 vs -30%, 도박판 시작!"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1638913970895-d3df59be1466?w=800&h=400&fit=crop'
            }
        ];
