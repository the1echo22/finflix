...
<p><strong>한 줄 정리:</strong> "98% 빠진 위너즈, 이제 올라갈 일만 남았다? 격투기 플랫폼 실사용 늘면서 800% 반등 가능성. 소액으로 도전해볼만!"</p>
                ...
                readTime: 6,
                image: 'https://images.unsplash.com/photo-1644361567696-3d871814b4cd?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 4,
...
<p><strong>한 줄 정리:</strong> "이더리움이 벤츠라면 솔라나는 테슬라. 빠르고 싸고 혁신적. 근데 가끔 서버 다운됨ㅋㅋ"</p>
                ...
                readTime: 7,
                image: 'https://images.unsplash.com/photo-1593510987185-1ec2256148a3?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 5,
...
<p><strong>한 줄 정리:</strong> "테슬라는 자동차 회사가 아니라 AI/에너지 회사. 근데 CEO가 트위터에서 정치질하면 주가 털림ㅋㅋ"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1611223235982-891064f27716?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 6,
...
<p><strong>한 줄 정리:</strong> "삼성이 드디어 일 냈다! 테슬라 22조 먹고 TSMC 추격 시작. 5만원대가 마지막 승차 기회일지도?"</p>
                ...
                readTime: 7,
                image: 'https://images.unsplash.com/photo-1592861956120-e524fc739696?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 7,
...
<p><strong>한 줄 정리:</strong> "서울 27.7%가 15억 넘었다. MZ는 마용성 전세 살면서 리츠로 월 6% 받자. 집값? 포기하면 편해"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1613442301239-ea2478101ea7?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 8,
...
<p><strong>한 줄 정리:</strong> "한미약품이 체중 -40% 신약 만들었다. 노보, 릴리 제쳤다고? 주가 44만원 가즈아!"</p>
                ...
                readTime: 9,
                image: 'https://images.unsplash.com/photo-1631218785711-84d77b3957f8?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 9,
...
<p><strong>한 줄 정리:</strong> "늑대가 왔어요 10년째 외치는 할배들. 언젠간 맞겠지만 그때까지 얼마나 더 올라갈지는 아무도 몰라. 적당히 경계하되 공포에 팔지 마!"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1631086459990-06bc4d7ad6cf?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 10,
...
<p><strong>한 줄 정리:</strong> "적자지만 사용자는 폭증 중. 수익 모델만 찾으면 대박. 근데 그게 언제?"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1632510231176-3d5fa9a233ed?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 11,
...
<p><strong>한 줄 정리:</strong> "AI 아이폰으로 5억대 팔면 주가 250달러. 삼성 긴장해야 될 듯"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1609358905581-e5381612486e?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 13,
...
<p><strong>한 줄 정리:</strong> "전기차는 미국 2위, 수소차는 독점, 로봇까지. 30만원 간다"</p>
                ...
                readTime: 6,
                image: 'https://images.unsplash.com/photo-1549421263-6064833b071b?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 16,
...
<p><strong>한 줄 정리:</strong> "74달러→9달러 폭락은 끝. 대선 시즌 다가오면 최소 2배는 간다"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1609743522471-83c84ce23e32?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 22,
...
<p><strong>한 줄 정리:</strong> "트럼프 아들 코인 9/1 거래 시작. 정치+크립토 콜라보는 처음이라 도박 각"</p>
                ...
                readTime: 5,
                image: 'https://images.unsplash.com/photo-1519995451813-39e29e054914?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 23,
...
<p><strong>한 줄 정리:</strong> "중국 부동산 18조 달러 증발, 일본식 장기침체 진입. 한국 수출 비상등!"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1523503250804-4e90aede2516?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 26,
...
<p><strong>한 줄 정리:</strong> "블랙록이 선택한 앱토스! 기관 머니 유입으로 $20 간다"</p>
                ...
                readTime: 7,
                image: 'https://images.unsplash.com/photo-1666625569267-8ffdd7d79772?w=800&h=400&fit=crop'
            },
            {
                id: Date.now() + 28,
...
<p><strong>한 줄 정리:</strong> "PEPE 밈코인 3위 등극! 20배 vs -30%, 도박판 시작!"</p>
                ...
                readTime: 8,
                image: 'https://images.unsplash.com/photo-1638913662252-70efce1e60a7?w=800&h=400&fit=crop'
            }
        ];
